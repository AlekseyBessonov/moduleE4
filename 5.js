class Device {
    ...
    getPower() {
        ...
        console.log(`Потребляемая мощность: ${power}`);
    }
    getPrice() {
...
let computer1 = new Computer(3,220,1200,'Intel',2300,16000,2000,'nVidia 2080Ti');
let computer2 = new Computer(4,220,30000,'Intel Xeon',3200,64000,12000,'intel');
let lamp1 = new Lamp(1,220,70,'tabletop','modern',1,'red');
